####### Python script to scrape posts from a specific threads.com account ####
...
# Profile Link for scraping

link = 'https://www.DESIREDLINK.net'

# Insert name for the file to be saved under

file_name = 'NAME'

######## Start ScrapFly Code #########################
######## imported 'parse_thread' function ############
...
######### end of imported 'parse_thread' function ########################
...
## Modified if-conditiuon to write data json file 'outfile.json' ###

if __name__ == "__main__":
	data = scrape_profile(link)
	with open(f'{file_name}.json', 'w') as of:
